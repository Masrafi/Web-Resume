...
class _MailPageState extends State<MailPage> {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return showcaseMailTile(_three, true, context, showCaseDataModel.first);
                  }
                  return MailTile(
                    mail: showCaseDataModel[index % showCaseDataModel.length],
                  );
                },
              ),
            ),
  ...
  GestureDetector showcaseMailTile(GlobalKey<State<StatefulWidget>> key,
      bool showCaseDetail, BuildContext context, ShowCaseDataModel mail) {
