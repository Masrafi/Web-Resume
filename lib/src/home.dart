...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    children:  [
      IntroScreen(),
      SizedBox(height: 30,),
      Text('INTRODUCTION AND OBJECTIVE', style: AppTextStyle.introTextStyle(),),
      ObjectiveScreen(),
      SizedBox(height: 30,),
      Text('WORK EXPERIENCE'),
      WorkScreen(),
      SizedBox(height: 30,),
      Text('APP IN GOOGLE PLAY & APP STORE'),
      WorkExScreen(),
      SizedBox(height: 30,),
      ...
      ProjScreen(),
      SizedBox(height: 30,),
      Text('PARTICIPATION IN TRAINING'),
      TrainScreen(),
      SizedBox(height: 30,),
      Text('ORGANISATIONAL CERTIFICATE'),
      CerScreen(),
      SizedBox(height: 30,),
