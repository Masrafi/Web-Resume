                        ...
                        children: [
                              ...
                              Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      AppDivider(),
                                      SizedBox(height: 5),
                                      ShowFrame(text: data[index].flutter.f13),
                                      SizedBox(height: 5),
                                      AppDivider(),
                                      SizedBox(height: 5),
                                      ShowFrame(text: data[index].flutter.f14),
                                      SizedBox(height: 5),
                                      AppDivider(),
                                      SizedBox(height: 5),
                                      ShowFrame(text: data[index].flutter.f15),
                                    ],
                                  )),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 10,
                                child: ShowFrame(
                                  text: data[index].exception_handle,
                                ),
                              )
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 10,
                                child: ShowFrame(text: data[index].swift),
                              )
                            ],
                          ),
                          SizedBox(height: 10),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                  flex: 10,
                                  child: ShowFrame(text: data[index].ide)),
                            ],
                          ),
                          SizedBox(height: 10),
                          AppDivider(),
